...
define([ 'jquery', 'underscore', 'backbone', 'config/config', 'factory' ],
    function($, _) {
      ...
      var addView = function(viewList, options) {
        ...
        viewList[options.selector][name] = options.initialize(options.view,
            $('#' + selector));
        ...
        if (_.isFunction(viewList[options.selector][name].render)) {
          ...
          viewList[options.selector][name].render = function() {
            var result = tempRender.apply(viewList[options.selector][name],
                arguments);
      ...
      return {
        ...
        show : function(options) {
          ...
          if (!this.viewList[options.selector]
              || !this.viewList[options.selector][options.name]) {
